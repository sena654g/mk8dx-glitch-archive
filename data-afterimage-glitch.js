const afterimagePages = {
    ...
    <tbody>
        <tr>
            <td class="name-cell"><a href="#afterimage-yoshi-island">Yoshi's Island</a></td>
            <td class="thumb-cell"><img src="images/icons/Yoshi's_Island_Icon.webp" class="course-thumb"></td>
        </tr>
        <tr>
            <td class="name-cell"><a href="#afterimage-squeak-clean-sprint">Squeaky Clean Sprint</a></td>
    ...
    "afterimage-yoshi-island": {
        title: "Yoshi's Island - Afterimage",
        html: `
    ...
    "afterimage-squeak-clean-sprint": {
        title: "Sky-Hige Sundaea - Afterimage",
        html: `
